...
//	int			switch_after = 400;
	int			num_locations = 4;
	int			target;
	coords_t	targets[2][NUM_BEES][4] = {
		{
			{{3, 3}, {3, 10}, {3, 27}, {11, 28}},
			{{3, 16}, {3, 22}, {7, 25}, {11, 27}},
			{{9, 16}, {16, 16}, {12, 25}, {12, 27}},
			{{22, 16}, {22, 22}, {17, 25}, {13, 27}},
			{{22, 3}, {22, 10}, {22, 27}, {13,28}}
		},
		{
			{{3, 27}, {3, 20}, {3, 3}, {11, 2}},
			{{3, 14}, {3, 8}, {7, 5}, {11, 3}},
			{{9, 14}, {16, 14}, {12, 5}, {12, 3}},
			{{22, 14}, {22, 8}, {17, 5}, {13, 3}},
			{{22, 27}, {22, 20}, {22, 3}, {13, 2}}
		}
	};
